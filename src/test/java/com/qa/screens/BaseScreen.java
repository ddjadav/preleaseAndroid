...
public class BaseScreen {
    ...
    public void scrollAndClickCityDropDown(String city){
        driver.findElement(MobileBy.AndroidUIAutomator
                ("new UiScrollable(new UiSelector().scrollable(true).instance(0)).scrollIntoView(new UiSelector().textContains(\""+city+"\").instance(0))"))
                .click();
    }
